...
void createSquare(void)
{
	...
	vertices[0] = -0.5; vertices[1] = -0.5; vertices[2] = 0.5; vertices[3] = 0.0f; vertices[4] = 0.0f;// Bottom left corner 
	colors[0] = 1.0; colors[1] = 1.0; colors[2] = 1.0; // Bottom left corner

	vertices[5] = -0.5; vertices[6] = 0.5; vertices[7] = 0.5; vertices[8] = 0.0f; vertices[9] = 1.0f;// Top left corner
	colors[3] = 1.0; colors[4] = 0.0; colors[5] = 0.0; // Top left corner

	vertices[10] = 0.5; vertices[11] = 0.5; vertices[12] = 0.5; vertices[13] = 1.0f; vertices[14] = 1.0f;// Top Right corner
	colors[6] = 0.0; colors[7] = 1.0; colors[8] = 0.0; // Top Right corner

	vertices[15] = 0.5; vertices[16] = -0.5; vertices[17] = 0.5; vertices[18] = 1.0f; vertices[19] = 0.0f;// Bottom right corner	
	colors[9] = 0.0; colors[10] = 0.0; colors[11] = 1.0; // Bottom right corner

	vertices[20] = -0.5; vertices[21] = -0.5; vertices[22] = 0.5; vertices[23] = 0.0f; vertices[24] = 0.0f;// Bottom left corner	
	colors[12] = 1.0; colors[13] = 1.0; colors[14] = 1.0; // Bottom left corner

	vertices[25] = 0.5; vertices[26] = 0.5; vertices[27] = 0.5; vertices[28] = 1.0f; vertices[29] = 1.0f;// Top Right corner
	...
	glVertexAttribPointer(pos, 3, GL_FLOAT, GL_FALSE, 5 * sizeof(GLfloat), 0);

	GLint text = glGetAttribLocation(program, "in_Coord");
	glEnableVertexAttribArray(text);
	glVertexAttribPointer(text, 2, GL_FLOAT, GL_TRUE, 5 * sizeof(GLfloat), (const GLvoid*)(3 * sizeof(GLfloat)));
	...
	GLuint Mytexture;
	glGenTextures(0, &Mytexture);
	unsigned char *g_image_data = ImgLoader::Load("./thisfig.bmp");
	glBindTexture(GL_TEXTURE_2D, Mytexture);
	glActiveTexture(GL_TEXTURE0);
	glUniform1i(glGetUniformLocation(program, "fig"), 0);
	glTexEnvf(GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE, GL_MODULATE);
	glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST);
	glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
	glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, 300, 300, 0, GL_BGR, GL_UNSIGNED_BYTE, g_image_data);
