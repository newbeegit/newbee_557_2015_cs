...
int main(int argc, const char * argv[])
{
	...
	*/
	...
	light_source6._ambient_intensity = 0.01;
	light_source6._specular_intensity = 0.0;
	light_source6._diffuse_intensity = 3.0;
	light_source6._attenuation_coeff = 0.001;
	...
	material4._diffuse_material = glm::vec3(1.0, 1.0, 1.0);
	material4._ambient_material = glm::vec3(1.0, 1.0, 1.0);
	...
	material4._diffuse_material = glm::vec3(0.301, 0.754, 0.027);
	material4._ambient_material = glm::vec3(0.301, 0.754, 0.027);
	...
	light_source1._ambient_intensity = 0.21;
	light_source1._specular_intensity = 5.0;
	light_source1._diffuse_intensity = 0.5;
	light_source1._attenuation_coeff = 0.01;
	light_source1._cone_angle = 15.0; // in degree
	light_source1._cone_direction = glm::vec3(0.0, -13.0, -35.0); // this must be aligned with the object and light position.
	light_source1._inner_angle = 13.0;
	light_source1._outer_angle = 15.0;

	GLDirectLightSource  light_source2;
	light_source2._lightPos = glm::vec4(-20.0, -10.0, 20.0, 0.0);
	light_source2._ambient_intensity = 0.01;
	light_source2._specular_intensity = 1.5;
	light_source2._diffuse_intensity = 0.4;
	light_source2._attenuation_coeff = 0.32;
	...
	// Create a material object
	GLMaterial material;
	material._diffuse_material = glm::vec3(1.0, 1.0, 1.0);
	material._ambient_material = glm::vec3(1.0, 1.0, 1.0);
	material._specular_material = glm::vec3(1.0, 1.0, 1.0);
	...
	material._diffuse_material = glm::vec3(0.931, 0.854, 0.027);
	material._ambient_material = glm::vec3(0.931, 0.854, 0.027);
	apperance->updateMaterial();
